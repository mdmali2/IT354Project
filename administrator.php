<?php
  ...
  if (isset($_GET['view']))
  {
    ...
    while($row = mysqli_fetch_array($catResult))
    {
      ...
      echo "<a href='petProfile.php?id=" . $row['id'] . "&type=cat&image=" . $row['image'] . "&name=". $row['name'] . "&shelter=". $row['shelter']. "&description=" . $row['description'] . "&declawed=" . $row['declawed'] . "'><div class='img-overlay'>";
  ...
  while($row = mysqli_fetch_array($dogResult))
  {
    ...
    echo "<figure class='img-overlay'>";
          echo "<a href='petProfile.php?id=" . $row['id'] . "&type=dog&image=" . $row['image'] . "&name=" . $row['name'] . "&breed=" . $row['breed'] . "&shelter=" . $row['shelter'] . "&description=" . $row['description'] . "&fee=" . $row['fee'] . "'><div class='img-overlay'>";
    echo "<img class='resize' src='images/" . $row['image'] . "' >";
